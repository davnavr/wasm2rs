...
fn write_i8_load(
    ...
    let _ = write!(
        out,
        "let {}: {destination} = {}::i8_load::<{}, {}, embedder::Memory{}, embedder::State>({}, {address}, &self.embedder)?",
...
fn write_i16_load(
    ...
    let _ = write!(
        out,
        "let {}: {destination} = {}::i16_load::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, &self.embedder)?",
        StackValue(validator.operand_stack_height() - 1),
        paths::MEMORY,
        memarg.offset,
        memarg.align,
    ...
    while !operators.eof() {
        ...
        match op {
            ...
            Operator::LocalGet { local_index } => {
                ...
                let _ = writeln!(out, " = {};", LocalId(local_index));
            }
            ...
            Operator::GlobalGet { global_index } => {
                ...
                if let Some(ty) =
                    wasmparser::WasmModuleResources::global_at(validator.resources(), global_index)
                {
                    let _ = write!(out, ": {}", ValType(ty.content_type));
                }
            ...
            Operator::I32Load { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "let {}: i32 = {MEMORY}::i32_load::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, &self.embedder)?;",
                    StackValue(validator.operand_stack_height() - 1),
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
            ...
            Operator::I64Load { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "let {}: i64 = {MEMORY}::i64_load::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, &self.embedder)?;",
                    StackValue(validator.operand_stack_height() - 1),
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
            ...
            Operator::F32Load { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "let {}: f32 = f32::from_bits({MEMORY}::i32_load::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, &self.embedder)? as u32);",
                    StackValue(validator.operand_stack_height() - 1),
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
            ...
            Operator::F64Load { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "let {}: f64 = f64::from_bits({MEMORY}::i64_load::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, &self.embedder)? as u64);",
                    StackValue(validator.operand_stack_height() - 1),
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
            ...
            Operator::I64Load32S { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "let {}: i64 = {MEMORY}::i32_load::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, &self.embedder)? as i64;",
                    StackValue(validator.operand_stack_height() - 1),
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
            ...
            Operator::I64Load32U { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "let {}: i64 = {MEMORY}::i32_load::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, &self.embedder)? as u32 as i64;",
                    StackValue(validator.operand_stack_height() - 1),
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
            ...
            Operator::I32Store { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "{MEMORY}::i32_store::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, {to_store}, &self.embedder)?;",
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
                    memarg.memory,
            ...
            Operator::I64Store { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "{MEMORY}::i64_store::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, {to_store}, &self.embedder)?;",
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
                    memarg.memory,
            ...
            Operator::F32Store { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "{MEMORY}::i32_store::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, {to_store}.to_bits() as i32, &self.embedder)?;",
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
                    memarg.memory,
            ...
            Operator::F64Store { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "{MEMORY}::i64_store::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, {to_store}.to_bits() as i64, &self.embedder)?;",
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
                    memarg.memory,
            ...
            Operator::I32Store8 { memarg } | Operator::I64Store8 { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "{MEMORY}::i8_store::<{}, {}, embedder::Memory{}, embedder::State>({}, {address}, {to_store} as i8, &self.embedder)?;",
                    memarg.offset,
                    memarg.memory,
                    memarg.memory,
                    MemAccess::new(memarg.memory, import_counts),
            ...
            Operator::I32Store16 { memarg } | Operator::I64Store16 { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "{MEMORY}::i16_store::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, {to_store} as i16, &self.embedder)?;",
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
                    memarg.memory,
            ...
            Operator::I64Store32 { memarg } => {
                ...
                let _ = writeln!(
                    out,
                    "{MEMORY}::i32_store::<{}, {}, {}, embedder::Memory{}, embedder::State>({}, {address}, {to_store} as i32, &self.embedder)?;",
                    memarg.offset,
                    memarg.align,
                    memarg.memory,
                    memarg.memory,
            ...
            Operator::F32Const { value } => {
                let _ = writeln!(
                    out,
                    "let {}: f32 = f32::from_bits({:#010X}u32);",
                    StackValue(validator.operand_stack_height()),
                    value.bits(),
                );
            }
            Operator::F64Const { value } => {
                let _ = writeln!(
                    out,
                    "let {}: f64 = f64::from_bits({:#018X}u64);",
                    StackValue(validator.operand_stack_height()),
                    value.bits(),
                );
            }
            ...
            /* Operator::I32Eq | Operator::I64Eq | Operator::F32Eq | Operator::F64Eq => {
                ...
                let _ = writeln!(
                    out,
                    "let {result_value:#}: i32 = ({result_value} == {}) as i32;",
                    PoppedValue::pop(validator, 0)
                );
            } */
            ...
            /* Operator::I32LtS | Operator::I64LtS => {
                ...
                let _ = writeln!(out, "let {c_1:#}: i32 = ({c_1} < {c_2}) as i32;");
            } */
            /* Operator::I32LtU => {
                let c_2 = PoppedValue::pop(validator, 0);
                let c_1 = PoppedValue::pop(validator, 1);
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i32 = (({c_1} as u32) < ({c_2} as u32)) as i32;"
                );
            } */
            ...
            /* Operator::I64LtU => {
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i32 = (({c_1} as u64) < ({c_2} as u64)) as i32;"
                );
            } */
            /* Operator::I64GtU => {
                let c_2 = PoppedValue::pop(validator, 0);
            ...
            /* Operator::I32Add => {
                ...
                let _ = writeln!(
                    out,
                    "let {result_value:#}: i32 = i32::wrapping_add({result_value}, {});",
                    PoppedValue::pop(validator, 0)
                );
            } */
            /* Operator::I32Sub => {
                ...
                let _ = writeln!(
                    out,
                    "let {result_value:#}: i32 = i32::wrapping_sub({result_value}, {});",
                    PoppedValue::pop(validator, 0)
                );
            }
            Operator::I32Mul => {
                ...
                let _ = writeln!(
                    out,
                    "let {result_value:#}: i32 = i32::wrapping_mul({result_value}, {});",
                    PoppedValue::pop(validator, 0)
                );
            } */
            /* Operator::I32DivS => {
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i32 = {MATH}::i32_div_s({c_1}, {c_2}, &self.embedder)?;",
                );
            }
            Operator::I32DivU => {
                let c_2 = PoppedValue::pop(validator, 0);
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i32 = {MATH}::i32_div_u({c_1}, {c_2}, &self.embedder)?;",
                );
            } */
            /* Operator::I32RemS => {
                let c_2 = PoppedValue::pop(validator, 0);
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i32 = {MATH}::i32_rem_s({c_1}, {c_2}, &self.embedder)?;",
                );
            }
            Operator::I32RemU => {
                let c_2 = PoppedValue::pop(validator, 0);
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i32 = {MATH}::i32_rem_u({c_1}, {c_2}, &self.embedder)?;",
                );
            } */
            ...
            /* Operator::I32Shl => {
                let c_2 = PoppedValue::pop(validator, 0);
                let c_1 = PoppedValue::pop(validator, 1);
                let _ = writeln!(out, "let {c_1:#}: i32 = {c_1} << ({c_2} as u32 % 32);");
            } */
            /* Operator::I32ShrS => {
                let c_2 = PoppedValue::pop(validator, 0);
                let c_1 = PoppedValue::pop(validator, 1);
            ...
            Operator::I32ShrU => {
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i32 = (({c_1} as u32) >> ({c_2} as u32 % 32)) as i32;"
                );
            }
            Operator::I32Rotl => {
                let c_2 = PoppedValue::pop(validator, 0);
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i32 = {c_1}.rotate_left(({c_2} % 32) as u32);"
                );
            }
            Operator::I32Rotr => {
                let c_2 = PoppedValue::pop(validator, 0);
            ...
            /* Operator::I64Clz => {
                ...
                let _ = writeln!(
                    out,
                    "let {c:#}: i64 = (i64::leading_zeros({c}) as i32) as i64;"
                );
            }
            Operator::I64Ctz => {
                let c = PoppedValue::pop(validator, 0);
            ...
            /* Operator::I64Add => {
                ...
                let _ = writeln!(
                    out,
                    "let {result_value:#}: i64 = i64::wrapping_add({result_value}, {});",
                    PoppedValue::pop(validator, 0)
                );
            }
            Operator::I64Sub => {
                ...
                let _ = writeln!(
                    out,
                    "let {result_value:#}: i64 = i64::wrapping_sub({result_value}, {});",
                    PoppedValue::pop(validator, 0)
                );
            }
            Operator::I64Mul => {
                ...
                let _ = writeln!(
                    out,
                    "let {result_value:#}: i64 = i64::wrapping_mul({result_value}, {});",
                    PoppedValue::pop(validator, 0)
                );
            }
            Operator::I64DivS => {
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i64 = {MATH}::i64_div_s({c_1}, {c_2}, &self.embedder)?;",
                );
            }
            Operator::I64DivU => {
                let c_2 = PoppedValue::pop(validator, 0);
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i64 = {MATH}::i64_div_u({c_1}, {c_2}, &self.embedder)?;",
                );
            }
            Operator::I64RemS => {
                let c_2 = PoppedValue::pop(validator, 0);
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i64 = {MATH}::i64_rem_s({c_1}, {c_2}, &self.embedder)?;",
                );
            }
            Operator::I64RemU => {
                let c_2 = PoppedValue::pop(validator, 0);
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i64 = {MATH}::i64_rem_u({c_1}, {c_2}, &self.embedder)?;",
                );
            } */
            /* Operator::I64Shl => {
                let c_2 = PoppedValue::pop(validator, 0);
                let c_1 = PoppedValue::pop(validator, 1);
                let _ = writeln!(out, "let {c_1:#}: i64 = {c_1} << ({c_2} as u64 % 64);");
            } */
            /* Operator::I64ShrS => {
                let c_2 = PoppedValue::pop(validator, 0);
                let c_1 = PoppedValue::pop(validator, 1);
            ...
            Operator::I64ShrU => {
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i64 = (({c_1} as u64) >> ({c_2} as u64 % 64)) as i64;"
                );
            }
            Operator::I64Rotl => {
                let c_2 = PoppedValue::pop(validator, 0);
                ...
                let _ = writeln!(
                    out,
                    "let {c_1:#}: i64 = {c_1}.rotate_left(({c_2} % 64) as u32);"
                );
            }
            Operator::I64Rotr => {
                let c_2 = PoppedValue::pop(validator, 0);
            ...
            /* Operator::I32TruncF64S => {
                ...
                let _ = writeln!(
                    out,
                    "let {popped:#}: i32 = embedder::rt::math::i32_trunc_f64_s({popped}, &self.embedder)?;"
                );
            }
            ...
            /* Operator::I64TruncF32S => {
                ...
                let _ = writeln!(
                    out,
                    "let {popped:#}: i64 = embedder::rt::math::i64_trunc_f32_s({popped}, &self.embedder)?;"
                );
            }
            Operator::I64TruncF32U => {
                ...
                let _ = writeln!(
                    out,
                    "let {popped:#}: i64 = embedder::rt::math::i64_trunc_f32_u({popped}, &self.embedder)?;"
                );
            }
            Operator::I64TruncF64S => {
                ...
                let _ = writeln!(
                    out,
                    "let {popped:#}: i64 = embedder::rt::math::i64_trunc_f64_s({popped}, &self.embedder)?;"
                );
            }
            ...
            /* Operator::F32ReinterpretI32 => {
                ...
                let _ = writeln!(
                    out,
                    "let {popped:#}: f32 = f32::from_bits({popped} as u32);"
                );
            }
            ...
            Operator::I32Extend16S => {
                let popped = PoppedValue::pop(validator, 0);
                let _ = writeln!(out, "let {popped:#}: i32 = ({popped} as i16) as i32;");
            }
            Operator::I64Extend8S => {
                let popped = PoppedValue::pop(validator, 0);
                let _ = writeln!(out, "let {popped:#}: i64 = ({popped} as i8) as i64;");
            }
            Operator::I64Extend16S => {
                let popped = PoppedValue::pop(validator, 0);
                let _ = writeln!(out, "let {popped:#}: i64 = ({popped} as i16) as i64;");
            }
