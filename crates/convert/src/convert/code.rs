...
fn convert_impl(
    ...
    while !operators.eof() {
        ...
        match op {
            ...
            Operator::F32Lt | Operator::F64Lt => bin_op!(FxxLt),
            Operator::F32Gt | Operator::F64Gt => bin_op!(FxxGt),
            Operator::F32Le | Operator::F64Le => bin_op!(FxxLe),
            Operator::F32Ge | Operator::F64Ge => bin_op!(FxxGe),
            ...
            Operator::F32Abs | Operator::F64Abs => un_op!(FxxAbs),
            Operator::F32Neg | Operator::F64Neg => un_op!(FxxNeg),
            Operator::F32Ceil | Operator::F64Ceil => un_op!(FxxCeil),
            Operator::F32Floor | Operator::F64Floor => un_op!(FxxFloor),
            Operator::F32Trunc | Operator::F64Trunc => un_op!(FxxTrunc),
            Operator::F32Nearest | Operator::F64Nearest => un_op!(FxxNearest),
            Operator::F32Sqrt | Operator::F64Sqrt => un_op!(FxxSqrt),
            Operator::F32Add | Operator::F64Add => bin_op!(FxxAdd),
